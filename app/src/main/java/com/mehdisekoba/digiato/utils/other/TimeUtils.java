...
public class TimeUtils {
    private static final Map<Integer, String> persianMonths = new HashMap<>();
    ...
    static {
        persianMonths.put(1, "فروردین");
        persianMonths.put(2, "اردیبهشت");
        persianMonths.put(3, "خرداد");
        persianMonths.put(4, "تیر");
        persianMonths.put(5, "مرداد");
        persianMonths.put(6, "شهریور");
        persianMonths.put(7, "مهر");
        persianMonths.put(8, "آبان");
        persianMonths.put(9, "آذر");
        persianMonths.put(10, "دی");
        persianMonths.put(11, "بهمن");
        persianMonths.put(12, "اسفند");
    }
    /**
     * JavaSource_Calendar:
    ...
    public String getIranianMonthName() {
        return persianMonths.get(irMonth);
    }
    ...
    public void convertGregorianToIranian(int gYear, int gMonth, int gDay) {
        setGregorianDate(gYear, gMonth, gDay);
        // Now, the Iranian date is set, you can access it using getIranianDate() method
    }
    /**
     * setJulianDate:
